...
//  Popper
//
//  Created by Garrett Butchko on 8/2/20.
...
class loadingScene: SKScene {
    ...
    override func sceneDidLoad() {
        ...
        world1ArtShade!.size = CGSize(width: 828, height: 470)
        ...
        world2ArtShade!.size = CGSize(width: 828, height: 470)
        ...
        world3ArtShade!.size = CGSize(width: 828, height: 470)
        ...
        world4ArtShade!.size = CGSize(width: 828, height: 470)
        ...
        world5ArtShade!.size = CGSize(width: 828, height: 470)
        ...
        override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
            ...
            //let mainmenuscene = mainMenuScene(fileNamed: "GameScene")
            //let transition = SKTransition.fade(with: .black, duration: 4.0)
    ...
    func positions(){
        ...
        world1ArtShade!.position.x = world1Art!.position.x + 2
        world1ArtShade!.position.y = world1Art!.position.y - 8
        
        world2ArtShade!.position.x = world2Art!.position.x + 2
        world2ArtShade!.position.y = world2Art!.position.y - 8
        
        world3ArtShade!.position.x = world3Art!.position.x + 2
        world3ArtShade!.position.y = world3Art!.position.y - 8
        
        world4ArtShade!.position.x = world4Art!.position.x + 2
        world4ArtShade!.position.y = world4Art!.position.y - 8
        
        world5ArtShade!.position.x = world5Art!.position.x + 2
