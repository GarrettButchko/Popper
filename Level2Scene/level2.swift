...
class level2: SKScene, SKPhysicsContactDelegate {
    ...
    override func sceneDidLoad() {
        ...
        if HomeScene.level2HaveStar1 != nil{
        haveStar1 = HomeScene.level2HaveStar1
        }
        if HomeScene.level2HaveStar2 != nil{
        haveStar2 = HomeScene.level2HaveStar2
        }
        if HomeScene.level2HaveStar3 != nil{
        haveStar3 = HomeScene.level2HaveStar3
        }
        ...
        self.spike1 = self.childNode(withName: "spike1") as? SKSpriteNode
        ...
        spike1!.physicsBody?.restitution = 0
        ...
        player!.physicsBody?.categoryBitMask = ColliderType2.player2
        player!.physicsBody?.collisionBitMask = ColliderType2.ground2
        player!.physicsBody?.contactTestBitMask = ColliderType2.ground2
        
        ground!.physicsBody?.categoryBitMask = ColliderType2.ground2
        
        ramp!.physicsBody?.categoryBitMask = ColliderType2.ground2
        
        wall!.physicsBody?.categoryBitMask = ColliderType2.ground2
        
        ramp2!.physicsBody?.categoryBitMask = ColliderType2.ground2
        
        wall2!.physicsBody?.categoryBitMask = ColliderType2.ground2
        
        ramp3!.physicsBody?.categoryBitMask = ColliderType2.ground2
        
        wall3!.physicsBody?.categoryBitMask = ColliderType2.ground2
        
        spike1!.physicsBody?.categoryBitMask = ColliderType2.spike
        
        spike2!.physicsBody?.categoryBitMask = ColliderType2.spike
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        for t in touches {
            ...
            nextLevelButtonShade!.run(resetButtonShrink2)
                ...
                let changeScene = SKAction.run {
                let mainmenuscene = level3(fileNamed: "level3")
                mainmenuscene?.scaleMode = .aspectFill
                self.scene?.view?.presentScene(mainmenuscene!)
                    //, transition: SKTransition.fade(with: .black, duration: 3.0))
                }
    ...
    func positions(){
        ...
        cameraNode.position.y = player!.position.y + 120
            ...
            let cameraYMove = SKAction.move(to: CGPoint(x: player!.position.x + 200, y: ground!.position.y), duration: 2)
        ...
        if haveStar1 == false || haveStar1 == nil{
            ...
            Star1!.position = CGPoint(x: 80, y: 80)
            
            StarShade1!.position = CGPoint(x: 80, y: 72)
        }
        ...
        if haveStar2 == false || haveStar2 == nil{
            ...
            Star2!.position = CGPoint(x: 400, y: 240)
        
            StarShade2!.position = CGPoint(x: 400, y: 232)
        ...
        if haveStar3 == false || haveStar3 == nil{
            ...
            Star3!.position = CGPoint(x: 720, y: 80)
        
            StarShade3!.position = CGPoint(x: 720, y: 72)
    ...
    func resetfunc(){
        ...
        let runone = SKAction.run {
            ...
            if level2.haveStar12 == false || level2.haveStar12 == nil{
                if HomeScene.level2HaveStar1 != true{
                self.haveStar1 = false
                self.Star1!.position = CGPoint(x: 80, y: 80)
                self.Star1!.size = CGSize(width: 72, height: 72)
                self.Star1!.zPosition = -4
                self.StarShade1!.zPosition = -5
                self.StarShade1!.position = CGPoint(x: 80, y: 72)
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if finishLine!.contains(player!.position) {
            ...
            HomeScene.level2Completed = true
            passedFinishLine2 = true
            
            level2.haveStar12 = haveStar1
            level2.haveStar22 = haveStar2
            level2.haveStar32 = haveStar3
