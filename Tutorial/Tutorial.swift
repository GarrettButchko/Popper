...
class Tutorial: SKScene, SKPhysicsContactDelegate {
    ...
    var prevScoreCalcTime1:TimeInterval = 0
    ...
    weak var hand : SKSpriteNode?
    weak var speech: SKSpriteNode?
    weak var handShade : SKSpriteNode?
    weak var speechShade: SKSpriteNode?
    ...
    override func sceneDidLoad() {
        ...
        self.blocker = self.childNode(withName: "blocker") as? SKSpriteNode
        ...
        self.speechLabel = self.childNode(withName: "speechLabel") as? SKLabelNode
        ...
        self.hand = self.childNode(withName: "hand") as? SKSpriteNode
        self.speech = self.childNode(withName: "speech") as? SKSpriteNode
        self.handShade = self.childNode(withName: "handShade") as? SKSpriteNode
        self.speechShade = self.childNode(withName: "speechShade") as? SKSpriteNode
        speechLabel!.text = "Tap the right side to move right"
        ...
        player!.physicsBody?.categoryBitMask = ColliderType0.player
        player!.physicsBody?.collisionBitMask = ColliderType0.ground
        player!.physicsBody?.contactTestBitMask = ColliderType0.ground
        
        ground!.physicsBody?.categoryBitMask = ColliderType0.ground
        
        ramp!.physicsBody?.categoryBitMask = ColliderType0.ground
        
        wall!.physicsBody?.categoryBitMask = ColliderType0.ground
        ...
        //let Level1Signseq = SKAction.sequence([Wait3, fadein, Wait4, fadeout])
        ...
        if step1 == true{
            ...
            speechLabel!.text = "Tap the right half of the screen to move right"
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if firstBody.node?.name == "player" && secondBody.node?.name == "ground" {
            ...
            if passedFinishLine == true {
                ...
                hand!.position = mainMenu!.position
               
                
                hand!.zPosition = 60
                handShade!.zPosition = 59
                speech!.zPosition = 53
                speechLabel!.zPosition = 54
                speechShade!.zPosition = 52
                
                speechLabel!.text = "Click this to go back to the Menu."
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        for t in touches {
            ...
            if allowTouch == true{
                ...
                let signfadeout = SKAction.fadeOut(withDuration: 0.2)
                
                let signKill = SKAction.run {
                    self.Level1Sign!.removeFromParent()
                }
                
                let signseq = SKAction.sequence([signfadeout, signKill])
                
                Level1Sign!.run(signseq)
            ...
            if rightTouch!.contains(location!) || rampInOneRampGrid == true && ramp!.contains(location!) && oneGridInRight == true || ((wallInOneRightWallGrid == true || wallInOneLeftWallGrid == true) && wall!.contains(location!) && oneGridInRight == true) || ((floorInOneBottomFloorGrid == true || floorInOneTopFloorGrid == true) && floor!.contains(location!) && oneGridInRight == true){
                ...
                speechLabel!.text = "Tap the left half of the screen to move left."
            ...
            if leftTouch!.contains(location!) || (rampInOneRampGrid == true && ramp!.contains(location!) && oneGridInLeft == true) || ((wallInOneRightWallGrid == true || wallInOneLeftWallGrid == true) && wall!.contains(location!) && oneGridInLeft == true) || ((floorInOneBottomFloorGrid == true || floorInOneTopFloorGrid == true) && floor!.contains(location!) && oneGridInLeft == true){
                ...
                hand!.position = ramp!.position
                hand!.position.x = ramp!.position.x
                hand!.position.y = ramp!.position.y - 8
                    
                speechLabel!.text = "Drag the ramp into the light box."
    ...
    override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
         for t in touches {
            ...
            if touchingRamp == true && step3 == true{
                ...
                if rampeffectsAllowed == true {
                    ...
                    if ramp!.contains(location!){
                        ...
                        step4 = true
                            ...
                            speechLabel!.text = "Grab the three stars, start by going left."
                        ...
                        let explosion = SKAction.run {
                            ...
                            self.hand!.position = self.Star1!.position
    ...
    func positions(){
        ...
        handShade!.position.x = hand!.position.x
        handShade!.position.y = hand!.position.y - 8
        ...
        if haveStar3 == true{
            ...
            blocker!.physicsBody? = SKPhysicsBody.init(rectangleOf: CGSize(width: 0, height: 0))
            
        }
        
        
        if handonramp == true && step3 == true{
            
            
            
            hand!.position.x = player!.position.x + 360
            hand!.position.y = player!.position.y + 320
            handShade!.position.x = player!.position.x + 360
            handShade!.position.y = player!.position.y + 312
        ...
        if passedFinishLine == true{
            ...
            speechLabel!.position.x = cameraNode.position.x + 430
            speechLabel!.position.y = cameraNode.position.y + 10
            
            speech!.position.x = cameraNode.position.x + 430
            speech!.position.y = cameraNode.position.y
            speechShade!.position.x = cameraNode.position.x + 430
            speechShade!.position.y = cameraNode.position.y - 8
            
        }
        if passedFinishLine == false{
        speechLabel!.position.x = player!.position.x + 130
        speechLabel!.position.y = player!.position.y + 140
        
        speechLabel!.alpha = speech!.alpha
        
        speech!.position.x = player!.position.x + 130
        speech!.position.y = player!.position.y + 130
            
            speechShade!.position.x = player!.position.x + 130
            speechShade!.position.y = player!.position.y + 122
        ...
        Level1Sign!.position = cameraNode.position
        ...
        allowTouch = false
                     ...
                     darkBackGround!.zPosition = 40
                         ...
                         let runtwo = SKAction.run {
                            ...
                            self.speechLabel!.text = "Tap the right side to move right"
                           
                            
                            self.blocker!.physicsBody? = SKPhysicsBody.init(rectangleOf: CGSize(width: self.blocker!.size.width, height: self.blocker!.size.height))
                            
                            self.hand!.zPosition = 29
                            self.speech!.zPosition = 26
                            self.handShade!.zPosition = 28
                            self.speechShade!.zPosition = 25
                            self.speechLabel!.zPosition = 27
                         }
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if passedFinishLine == false {
            ...
            if Star1!.contains(player!.position) && step4 == true{
                
                hand!.position = Star2!.position
            ...
            if Star2!.contains(player!.position) && haveStar1 == true{
                        
                hand!.position = Star3!.position
            ...
            if Star3!.contains(player!.position) && haveStar2 == true{
                    
                step4 = false
                step5 = true
                
                hand!.position.x = finishLine!.position.x
                hand!.position.y = finishLine!.position.y - 400
                
                
                speechLabel!.text = "Pass the finish line to keep your stars."
    ...
    if currentTime - prevScoreCalcTime > 1 {
        ...
        if step3 == true{
            ...
            let code = SKAction.run {
                ...
                self.handonramp = false
                self.hand!.position = self.ramp!.position
                
                
            }
            
            let code2 = SKAction.run {
                if self.step4 == true{
                self.hand!.position = self.Star1!.position
            ...
            let handmovedown = SKAction.move(to: oneGrid!.position, duration: 0.5)
            
            
            let sequence = SKAction.sequence([ code, handmovedown, code2])
        ...
        if step1 == true{
            ...
            if currentTime - prevScoreCalcTime > 0.5 {
                prevScoreCalcTime = currentTime
                
                upfinger = SKAction.run {
                    
                    self.hand!.position.y = self.cameraNode.position.y + 60
                   
                    
                }
                
                downfinger = SKAction.moveTo(y: cameraNode.position.y - 20, duration: 0.5)
        
                updownfinger = SKAction.sequence([upfinger!, downfinger!])
                
                hand!.run(updownfinger!)
                
            }
            
            hand!.position.x = cameraNode.position.x + 400
        ...
        if step2 == true{
            ...
            hand!.position.x = cameraNode.position.x - 300
        }
